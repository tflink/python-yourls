# -*- coding: utf-8 -*-
#
# Yourls Client documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../yourls'))
...
version = ".".join(yourls.__version__.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = yourls.__version__
